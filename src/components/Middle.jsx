...
Command: npx gltfjsx@6.5.3 public/models/rpm-avatar-vr-1.glb -o src/components/Middle.jsx -r public 
*/
...
export function Middle(props) {
   const {
      ...
      morphTargetSmoothing: 1.00,
      script: {
        value: "podcast",
        options: ["welcome", "pizzas","podcast"],
      },
    });
  ...
  const { scene, animations } = useGLTF('/models/rpm-avatar-vr-1.glb')
  ...
  useEffect(() => {
    ...
    // Checking for morph targets and logging
    // React.useEffect(() => {
    //   const morphTargets = [
    ...
    //     if (targetNode && targetNode.morphTargetInfluences) {
    //       console.log(`${target} exists with morph target influences.`);
    //     } else {
...
useGLTF.preload('/models/rpm-avatar-vr-1.glb')
